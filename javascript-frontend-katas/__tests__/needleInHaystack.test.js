...
describe("needleInHaystack()", () => {
  ...
  it("Returns the correct path for multiple instances sorted alphabetically", () => {
    ...
    expect(needleInHaystack(haystack, needle)).toEqual(["contactDetails.address.office", "contactDetails.web", "name", "reviews.april.chris", "reviews.may.louise"]);
  });
});
